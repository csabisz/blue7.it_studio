...
$update_data['o_special_agreement_price']=(float)str_replace(',', '.',$prod->xss_fix($_POST['total_special_agreement_price']));					
...
<input type="hidden" name="client_language_id" value="<?php echo $order['client_language_id']; ?>" form="order_details">
			<div class="row border-top border-bottom mx-0 w-100">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm d-inline" id="plot_link" name="plot_link" data-o_id="<?php echo $o_id; ?>" value="<?php echo $order['plot_link']; ?>" style="width:450px;" form="order_details">
                </div>
                <script type="text/javascript">
