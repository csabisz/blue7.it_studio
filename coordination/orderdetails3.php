...
<div class="page-content">
        ...
        ?>  
            ...
            <p class="display-4 w-100 text-center mt-3"> Order ID <?php echo $o_id; 
                    ...
                    {
                        ?>
                        - <a href="<?php echo $_SERVER['PHP_SELF'];?>?o_id=<?php echo $order['om_id'];?>" target="_blank"><?php echo $order['om_id'];?></a>
                        <?php
                    }		
                    ?> - <?php echo $order['order_name'];?></p>
    <div id="tasks_scroll" style="overflow-y:scroll;height:720px;min-height:1050px;">
        <div class="page-content pb-0">
            <div class="row w-100 mx-0 project-details d-flex justify-content-center pb-4">
                <div class="col-md-4">
                    ...
                    <p class="mb-0 d-inline">Purchaser: <?php echo $client['client_ID']; ?> - Enterprise: <?php echo $client['clientname']; ?> - <?php 
                ...
                <div class="col-md-4">
                    ...
                    {
                    ?>    
                        <span class="text-danger">Deadline: <input type="textbox" id="o_deadline" class="form-control form-control-sm text-danger d-inline" value="<?php echo $order['o_deadline']; ?>" style="width:170px;"> UTC+0</span>
                    ...
                    {
                        ?>    
                        <input type="textbox" id="o_deadline" class="form-control form-control-sm text-success d-inline" value="No Deadline" style="width:170px;"> UTC+0
                    ...
                    <button class="btn btn-sm btn-danger px-2 ml-4 mr-auto mr-md-0 ml-md-4 ml-auto d-md-inline" id="notification_btn">Notifications <span> <?php echo ($order['notifications']==1)?"are ON":"are OFF";?></span></button>
                    <script type="text/javascript">
                    $("#notification_btn").click(function(){
                        $.ajax({
                            url: "../ajax/update_notification.php",
                            method: "post",
                            data: {o_id:$("input[name=o_id").val(),notifications:$("input[name=notifications").val()},
                            dataType:"html",
                            success:function(data) {
                                //console.log(data);	
                                if(data==0)
                    ...
                    <button id="on_stock_btn" class="btn btn-sm <?php echo ($order['on_stock']==0)?"btn-success":"btn-warning";?> px-2 ml-4 mr-auto mr-md-0 ml-md-4 ml-auto d-md-inline"><?php echo ($order['on_stock']==0)?"Normal! Put On Stock":"Put On Normal";?></button>
                    <script type="text/javascript">
                    ...
                    <div class="row mx-0 w-100 costomer-item py-2">
                        <div class="col-md-2 col-12 d-flex justify-content-md-start justify-content-center pl-4 pl-md-1 py-2 py-md-0">
                            ...
                            ?>    
                                ...
                                <img src="../client_files/<?php echo $customer_files[$i]['of_path_dom'].$customer_files[$i]['of_internal_name_dom'];?>" class="img-responsive d-inline pl-2 cursor-pointer" alt="<?php echo $customer_files[$i]['of_name_client']; ?>" width="40" height="30">
                                </div>
                                <!--<script type="text/javascript">
                            ...
                            {
                            ?>    
                                <img src="../img/adobe-pdf-icon.png" class="d-inline pl-2" alt="<?php echo $customer_files[$i]['of_name_client']; ?>" width="40" height="30">
                            <?php    
                            }
                            ?>
                        </div>
                        <div class="col-md-2 col-12 d-flex">
                            <div class="form-group w-100 align-self-center mb-0">
                                <select name="change_note<?php echo $i;?>" id="change_note<?php echo $i;?>" class="form-control form-control-sm">
                        ...
                        <div class="col-md-1 col-12 pl-4 pl-md-0 d-flex">
                            <div class="form-group w-100 align-self-center mb-0">
                                <select name="change_position<?php echo $i;?>" id="change_position<?php echo $i;?>" data-of_id="<?php echo $customer_files[$i]['of_id']; ?>" class="form-control form-control-sm">
                                <?php 
                                for($z=0;$z<100;$z++)
                                {
                                ?>
                                ...
                                <script type="text/javascript">
                                    $('#change_position<?php echo $i;?>').change(function(){
                                        ...
                                        method: "get",
                                        data: {change_position:$(this).val(),of_id:$(this).data('of_id'),option:"change_position"},
                                        dataType:"html",
                                        success:function(data) {
                                            console.log(data);										
                                        },
                        ...
                        <div class="col-md-1 col-12 pl-4 pl-md-0 d-flex">
                            <div class="form-group w-100 align-self-center mb-0">
                                <select name="change_position<?php echo $i;?>" id="change_exterior_position<?php echo $i;?>" data-of_id="<?php echo $customer_files[$i]['of_id']; ?>" class="form-control form-control-sm">
                                <?php 
                                for($z=0;$z<100;$z++)
                                {
                                ?>
                                ...
                                <script type="text/javascript">
                                    $('#change_exterior_position<?php echo $i;?>').change(function(){
                                        ...
                                        url: "../ajax/change_customer_file.php",
                                        method: "get",
                                        data: {change_exterior_position:$(this).val(),of_id:$(this).data('of_id'),option:"change_exterior_position"},
                                        dataType:"html",
                                        success:function(data) {
                                            console.log(data);										
                                        },
                        ...
                        <div class="col-md-3 d-flex justify-content-md-center pb-2 pb-md-0 col-12 d-flex justify-content-center pl-4 pl-md-0">
                            <div class="form-group d-inline mb-0 align-self-center w-100">
                                <select name="change_level<?php echo $i;?>" id="change_level<?php echo $i;?>" class="form-control form-control-sm d-inline">
                                <?php 
                                for($z=-4;$z<0;$z++)
                                {
                                ?>
                            ...
                            <a href="../image.php?filecategory=customerfiles&imageid=<?php echo $customer_files[$i]['of_id']; ?>" class="btn btn-sm btn-secondary align-self-center ml-1">Download</a>
                        </div>
                        <div class="col-md-2 d-flex justify-content-center pb-2 pb-md-0 col-12 pl-4 pl-md-0">
                            <div class="form-group d-inline align-self-center ml-2 mb-0">
                                    <input type="hidden" name="of_id" id="of_id<?php echo $i;?>" value="<?php echo $customer_files[$i]['of_id'];?>">
                                    <input type="text" name="of_name" id="of_name<?php echo $i;?>" class="form-control form-control-sm" value="<?php echo $customer_files[$i]['of_name'];?>" placeholder="Interior">
                                    <input type="text" name="of_name_ex" id="of_name_ex<?php echo $i;?>" class="form-control form-control-sm" value="<?php echo $customer_files[$i]['of_name_ex'];?>" placeholder="Exterior">
                                </div>
                                ...
                                <script type="text/javascript">
                                    $('#rename_btn<?php echo $i;?>').click(function(){
                                        ...
                                        url: "<?php echo $base_url;?>ajax/change_customer_file.php",
                                        method: "get",
                                        data: {of_id:$("#of_id<?php echo $i;?>").val(),
        ...
        <div class="row mx-0 w-100 interiordetails">
            <div class="row mx-0 w-100 py-2" id="b3_interior_columns">
        ...
        var start = 0;
        var limit = 5;
        var b3_in_reachedMax = false;

            $('#tasks_scroll').scroll(function () {
                //console.log('scroll position '+$('#tasks_scroll').scrollTop());
               
                //console.log('height '+$('#tasks_scroll').height());
                //var difference=$('#tasks_scroll').scrollTop() - $('#tasks_scroll').height();

                var scroll_percent=$('#tasks_scroll').scrollTop() * 100 / $('#tasks_scroll').height();
            ...
            function get_b3_in_tasks() {
                console.log("reached "+b3_in_reachedMax);

                console.log("start "+start);
                console.log("limit "+limit);

                if (b3_in_reachedMax==true)
                {
                return;
                }
                else
                {
                    console.log("reached in else "+b3_in_reachedMax);

                $.ajax({
                   url: 'b3_interior_products_with_scroll.php',
                   method: 'POST',
                   dataType: 'html',
                   data: {
                       o_id: <?php echo $o_id;?>,
                   ...
                   success: function(response) {
                        // if (response == "b3_in_reachedMax")
                        //     b3_in_reachedMax = true;
                        // else {
                        //     start += limit;
                        ...
                        {
                        start += limit;
                        $("#b3_interior_columns").append(response);
                        }
                    }
                });
                }
        ...
        {
            //include('b5_interior_products.php');
        }

        $b6_interior_products_with_extensions=$prod->get_b6_interior_products_with_extensions($o_id);

        if(count($b6_interior_products_with_extensions)>0)
        {
            //include('b6_interior_products.php');
        }
        ...
        $b8_interior_products_with_extensions=$prod->get_b8_interior_products_with_extensions($o_id);

        if(count($b8_interior_products_with_extensions)>0)
        {
           // include('b8_interior_products.php');
        }
        ...
        $b6_exterior_products_with_extensions=$prod->get_b6_exterior_products_with_extensions($o_id);

        if(count($b6_exterior_products_with_extensions)>0)
        {
            //include('b6_exterior_products.php');
        }
        ...
        $b8_exterior_products_with_extensions=$prod->get_b8_exterior_products_with_extensions($o_id);

        if(count($b8_exterior_products_with_extensions)>0)
        {
            //include('b8_exterior_products.php');
        }
