...
?>
                    ...
                    <div class="row w-100 mx-0">
                        ...
                        <div class="col-md-1">
                            ...
                            if ($order['om_id'] == 0) {
                                ...
                                echo $order['om_id'];
                            } ?>/tour" target="_blank" class="btn btn-sm btn-primary">Presentation</a>
                        </div>
                    </div>
                    <?php
                    if (strpos($osub_id, 'n') !== false) {
    ...
    <script>
        (function() {
            ...
            // Open modal when AI button is clicked
            document.addEventListener('click', function(e) {
                ...
                // Generate a simple token (in production, this should be a proper auth token)
            ...
            window.addEventListener('message', function(e) {
                ...
                switch (eventName) {
                    ...
                    case 'imageSaved':
                        ...
                        // Close the modal and reload the page to show the new image
                        closeAiModal();
                        window.location.reload(true);
                        break;
