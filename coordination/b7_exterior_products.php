            ...
            if ($b7_exterior_products_with_extensions[$k]['om_id'] != 0) {
                ...
                <div id="row<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id']; ?>">
                    ...
                    for ($i = 0; $i < count($allstatus); $i++) {
                        ...
                        $task_full_name = $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];
