                                    ...
                                    <div id="task<?= $prod_class ?>" style="border-radius: 10px"
                                                    ...
                                                    <div class="form-group align-self-center w-100 mb-0 d-flex">
                                                        ...
                                                        <div class="col-12">                                                                
                                                            ...
                                                            <select name="creators_<?= $prod_class ?>"
                                                                    ...
                                                                    class="creator form-control form-control-sm align-self-center">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $("#fileuploader_<?=$prod_class; ?>").uploadFile({
                                                    ...
                                                    url: "../upload_files_beta.php?filecategory=creatorfiles&o_id=<?=$o_id?>&osub_id=<?=$osub_id?>&prod_id=<?=$prod_id?>&uca_id=<?=$_COOKIE['client_id']?>",
                                        ...
                                        <div class="row w-100">
                                            ...
                                            <div class="col-md-8 d-flex justify-content-end">
                                                ...
                                                <br>
                                                <input type="checkbox" id="no_result_file<?php echo $o_id;?>_<?php echo $osub_id; ?>_<?php echo $prod_id;?>" class="form-control-sm form-control" value="1" style="width: 2vw;" <?php
                                                $found_no_result_file=0;

                                                for($f=0;$f<count($product['result_files']);$f++)
                                                {
                                                    if(($found_no_result_file==0)&&($product['result_files'][$f]['no_result_file']==1))
                                                    {
                                                        echo "checked";
                                                ...
                                                ?>>
                                                <label class="form-check-label" for="no_result_file<?php echo $o_id;?>_<?php echo $osub_id; ?>_<?php echo $prod_id;?>" style="width: fit-content;">No result file shall be uploaded</label>
                                                <script type="text/javascript">
                                                    $('#no_result_file<?php echo $o_id;?>_<?php echo $osub_id; ?>_<?php echo $prod_id;?>').click(function(){
                                    ...
                                    <div id="rollout_<?= $prod_class ?>" class="collapse">
                                        ...
                                        <div class="row w-100 mx-0 border-top border-white <?php echo ($file['orf_status'] == 0) ? "grey-dark" : "light-green"; ?>"
                                                        ...
                                                        <div class="justify-content-center w-100">
                                                            ...
                                                            <div class="file-name w-100 text-center d-flex flex-column justify-content-center">
                                                                   ...
                                                                   style="font-size: 13px;">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           value="<?php
                                                                            ...
                                                                            if(!empty($file_name1[1]))
                                                                            {
                                                                                $middle_part_with_space = explode('.', $file_name1[1]);
                                                                            }
                                                                            else
                                                                            {
                                                                                $middle_part_with_space = " ";
                                                                            }
                                                                ...
                                                                <script type="text/javascript">
                                                                    ...
                                                                    $('#file_name<?php echo $file['orf_id']?>').on('focusout',function () {
                                                ...
                                                <div class="w-100 d-flex justify-content-center">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <select name="result_files_visibility<?php echo $file['orf_id']; ?>"
                                                                ...
                                                                class="form-control form-control-sm" <?php echo ($file['no_result_file'] == 1) ? "disabled" : ""; ?>>
                                                            ...
                                                            <option value="1" <?php echo ($file['orf_status'] == 1) ? "selected" : ""; ?>>
                                                                Old
                                                            </option>
                                            ...
                                            <div class="col-6 px-2 py-0">
                                                ...
                                                <p class="my-0 d-flex" style="font-size:12px;">
                                                    ...
                                                    <input id="title<?php echo $file['orf_id']; ?>"
                                                           ...
                                                           value="<?php echo $file['pict_categ_name']; ?>">
                                            ...
                                            <div class="col-6 px-0 py-0 text-right">
                                                ...
                                                <?php
                                                if (in_array($file['orf_type_dom'], $validextensions)) {
                                                ?>
                                                <p class="my-0 pr-5" style="font-size:12px;">
                                                Compresssed: <?php echo $compressed_filesize = $prod->filesize_formatted("../result_compress_files/" . $file['orf_compress_path']); ?></p></p>
                                                <?php
                                                }
                                                ?>
                                            </div>
