            ...
            if ($b7_interior_products_with_extensions[$k]['om_id'] != 0) {
                ...
                <div id="row<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id']; ?>">
                    ...
                    for ($i = 0; $i < count($allstatus); $i++) {
                        ...
                        $task_full_name = $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];
                                           ...
                                           <img data-toggle="modal"
                                            ...
                                            ?>
                                                ...
                                                <div class="modal fade"
                                                     ...
                                                     aria-hidden="true">
                                                    <div id="modal-dialog<?php echo $image_preview_counter;?>" class="modal-dialog" role="document">
                                                ...
                                                <div id="image_tooltip_container_<?php echo $image_preview_counter; ?>">
                                                    ...
                                                    if ($b7_interior_products_with_extensions[$k]['prod_id'][4] != '6') {
                                                        ...
                                                        <img
                                                                ...
                                                                alt="<?php echo $result_files[$i]['orf_name']; ?>"
                                                                width="60" heigth="33.78"
                                                                class="d-inline img-fluid img-responsive">
                                                    <?php }
