...
$start=$prod->xss_fix($_POST['start']);
$limit=$prod->xss_fix($_POST['limit']);

$global_column_count = 0;

$b3_interior_products_with_extensions=$prod->get_b3_interior_products_with_extensions_scroll($o_id,$start,$limit);
