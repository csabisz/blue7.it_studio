...
for($i=0;$i<count($all_creators);$i++)
{
    ...
    ?>
        ...
        if(!empty($all_creators[$i]['c_last_name']))
        {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_2d_configurator'].")";
        }
        else
        {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_2d_configurator'].")";
        }?> </option>
    <?php
            }
        }	
    ...
    ?>
        ...
        if(!empty($all_creators[$i]['c_last_name']))
        {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_3d_configurator'].")";
        }
        else
        {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_3d_configurator'].")";
        }?> </option>
    <?php
            }
        }	
    ...
    ?>
        ...
        if(!empty($all_creators[$i]['c_last_name']))
        {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_2d_konfig_renders'].")";
        }
        else
        {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_2d_konfig_renders'].")";
        }?> </option>
    <?php
            }
        }

        if(((substr($prod_id,1)>1761)&&(substr($prod_id,1)<1766))||((substr($prod_id,1)>1781)&&(substr($prod_id,1)<1790)))
        {
    ...
    <?php
        ...
        if($prod_id=="p1766")
        {
            ...
            {
    ?>
        <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="b7_render_360_creator_task_count offline" value="<?php echo $all_creators[$i]['client_ID'];?>" data-creator_end_time="<?php echo $endtime['end_time'];?>" data-creator_start_time="<?php 
    ...
    ?>
        ...
        if(!empty($all_creators[$i]['c_last_name']))
        {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_render_slideshow'].")";
        }
        else
        {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_render_slideshow'].")";
        }?> <?php 
...
for($i=0;$i<count($all_other_creators);$i++)
{
    ...
    ?>
        <option id="creator_<?php echo $all_other_creators[$i]['client_ID']; ?>" class="b7_render_360_creator_task_count offline" value="<?php echo $all_other_creators[$i]['client_ID'];?>" data-creator_end_time="<?php echo $endtime['end_time'];?>" data-creator_start_time="<?php 
