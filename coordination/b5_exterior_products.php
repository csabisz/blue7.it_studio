...
<div class="row mx-0 w-100 exterior">
    ...
    <div class="row mx-0 w-100 py-2">
        ...
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            ...
            for ($k = 0;
            $k < count($b5_exterior_products_with_extensions);
            $k++)
            ...
            if ($b5_exterior_products_with_extensions[$k]['om_id'] != 0) {
                ...
                <div id="row<?php echo $b5_exterior_products_with_extensions[$k]['o_id'] . "_" . $b5_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b5_exterior_products_with_extensions[$k]['prod_id']; ?>">
                    ...
                    for ($i = 0; $i < count($allstatus); $i++) {
                                    ...
                                    <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                                        ...
                                        <div class="form-group align-self-center mb-0 w-100 d-flex">
                                            ...
                                            <select name="creators_<?php echo $global_creator_counter; ?>"
                                                    data-prod_id="<?php echo $b5_exterior_products_with_extensions[$k]['prod_id']; ?>"
                                                    id="creators_<?php echo $global_creator_counter; ?>"
                                                    data-selected_creator="<?php echo $b5_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                ...
                                                if ($creator_right['u_status'] == "active") {
                                                    ...
                                                    <option id="creator_<?php echo $b5_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                            ...
                                                            value="<?php echo $b5_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                            selected><?php
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("click", function () {
                                                        ...
                                                        if (counter == 0) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                data: {
                                                                    o_id:<?php echo $b5_exterior_products_with_extensions[$k]['o_id'];?>,
                                                                    osub_id: "<?php echo $b5_exterior_products_with_extensions[$k]['osub_id'];?>",
                                                                    prod_id: "<?php echo $b5_exterior_products_with_extensions[$k]['prod_id'];?>"
                                                                },
                                            ...
                                            <a href="taskdetails.php?o_id=<?php echo $b5_exterior_products_with_extensions[$k]['o_id']; ?>&osub_id=<?php echo $b5_exterior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b5_exterior_products_with_extensions[$k]['prod_id']; ?>"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group align-self-center mb-0">
                                        ...
                                        <select class="form-control form-control-sm" name=""
                                                data-osub_id="<?php echo $b5_exterior_products_with_extensions[$k]['osub_id']; ?>"
                                                data-prod_id="<?php echo $b5_exterior_products_with_extensions[$k]['prod_id']; ?>"
                                                id="product_status<?php echo $b5_exterior_products_with_extensions[$k]['o_id'] . "_" . $b5_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b5_exterior_products_with_extensions[$k]['prod_id']; ?>">
                                            ...
                                            for ($j = 1; $j < count($allstatus); $j++) {
                                                ...
                                                <option value="<?php echo $allstatus[$j]['ost_id']; ?>"
                                                        data-status="<?php echo $allstatus[$j]['ost_color']; ?>" <?php echo ($allstatus[$j]['ost_id'] == $b5_exterior_products_with_extensions[$k]['p_status']) ? "selected" : ""; ?>><?php echo ucfirst($allstatus[$j]['ost_name']); ?></option>
                        ...
                        $task_full_name = $b5_exterior_products_with_extensions[$k]['o_id'] . "_" . $b5_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b5_exterior_products_with_extensions[$k]['prod_id'];
                                                ...
                                                <p class="mb-0 pt-0 d-flex justify-content-center align-items-center"
                                                   style="font-size: 13px;">
                                                    ...
                                                    &nbsp;<input type="text" name="file_name"
                                                                 ...
                                                                 style="max-height: 18px;max-width: 70px;" value="<?php
                                        ...
                                        if (in_array($result_files[$i]['orf_type_dom'], $validextensions)) {
                                            ...
                                            <div id="image_tooltip_container_<?php echo $image_preview_counter; ?>">
                                                ...
                                                if (!empty($result_files[$i]['orf_thumbnail_path'])) {
                                                    ...
                                                    <a href="https://bauvorschau.com/index.php/images/optimized/100/1000/2021/<?php echo $result_files[$i]['orf_path_dom'] . $result_files[$i]['orf_internal_name_dom']; ?>"
                                                       target="_blank"><img
