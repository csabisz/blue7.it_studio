                                        ...
                                        if (in_array($result_files[$i]['orf_type_dom'], $validextensions)) {
                                            ...
                                            <div id="image_tooltip_container_<?php echo $image_preview_counter; ?>">
                                                ...
                                                if (!empty($result_files[$i]['orf_thumbnail_path'])) {
                                                    ...
                                                    <?php if ($b3_interior_products_with_extensions[$k]['prod_id'][4] != '6') { ?>
                                                        <a
                                                                href="https://bauvorschau.com/index.php/images/optimized/100/1000/<?php echo $result_files[$i]['orf_path_dom'] . $result_files[$i]['orf_internal_name_dom']; ?>"
                                                                target="_blank"><img
