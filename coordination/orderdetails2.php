                ...
                <div class="col-xl-6 px-0 border-right border-secondary">
                    ...
                    <div class="row mx-0 w-100 costomer-item py-2">
                        ...
                        <div class="col-md-1 col-12 pl-4 pl-md-0 d-flex">
                            <div class="form-group w-100 align-self-center mb-0">
                                <?php /* <select name="change_position<?php echo $i;?>" id="change_position<?php echo $i;?>" data-of_id="<?php echo $customer_files[$i]['of_id']; ?>" class="form-control form-control-sm">
                                <?php 
                                for($z=0;$z<100;$z++)
                                {
                                ?>
                        ...
                        <div class="col-md-1 col-12 pl-4 pl-md-0 d-flex">
                            <div class="form-group w-100 align-self-center mb-0">
                                <?php /* <select name="change_position<?php echo $i;?>" id="change_exterior_position<?php echo $i;?>" data-of_id="<?php echo $customer_files[$i]['of_id']; ?>" class="form-control form-control-sm">
                                <?php 
                                for($z=0;$z<100;$z++)
                                {
                                ?>
                        ...
                        <div class="col-md-2 d-flex justify-content-center pb-2 pb-md-0 col-12 pl-4 pl-md-0">
                            <div class="form-group d-inline align-self-center ml-2 mb-0">
                                    <?php /* <input type="hidden" name="of_id" id="of_id<?php echo $i;?>" value="<?php echo $customer_files[$i]['of_id'];?>">
