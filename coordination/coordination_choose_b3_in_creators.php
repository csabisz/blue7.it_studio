...
{
    $creator_endtime=$prod->get_creator_end_time($all_creators[$i]['client_ID']);
    ...
    if($creator_right['u_status']=="active")
    {
        ...
        if($prod_id=="p1301")
        {
            ...
            {
    ?>
        <option style="width:100%" id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" data-creator_task_count="<?php 
         ...
         {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b3_walls'].")(".$creator_qualification['b3_windows_doors'].")";
         }
         else
        {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b3_walls'].")(".$creator_qualification['b3_windows_doors'].")";
        }?></option>
    ...
    ?>
        <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" data-creator_task_count="<?php 
         ...
         if(!empty($all_creators[$i]['c_last_name']))
         {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b3_furniture'].")";
         }
         else
         {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b3_furniture'].")";
         }?> </option>
    <?php
            }
        }	
...
{
    $other_creator_endtime=$prod->get_creator_end_time($all_other_creators[$i]['client_ID']);
    ...
    if($creator_right['u_status']=="active")
    {
        ...
        if($prod_id=="p1301")
        {
            if(($creator_qualification['b3_walls']>0)||($creator_qualification['b3_windows_doors']>0))
            {
                ...
                {
                    ?>
                    <option class="text-danger font-weight-bold">Resources from other companies</option>
                    <?php
