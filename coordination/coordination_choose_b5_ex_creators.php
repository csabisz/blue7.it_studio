...
for($i=0;$i<count($all_creators);$i++)
{
    ...
    ?>
        <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" data-creator_task_count="<?php 
            ...
            if(!empty($all_creators[$i]['c_last_name']))
            {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b5_2d_configurator'].")";
            }
            else
            {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b5_2d_configurator'].")";
            }?> </option>
        <?php
            }
        }
    ...
    ?>
        <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" data-creator_task_count="<?php 
            ...
            if(!empty($all_creators[$i]['c_last_name']))
            {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b5_3d_configurator'].")";
            }
            else
            {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b5_3d_configurator'].")";
            }?> </option>
        <?php
            }
        }
    ...
    ?>
        <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" data-creator_task_count="<?php 
            ...
            if(!empty($all_creators[$i]['c_last_name']))
            {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b5_2d_konfig_renders'].")";
            }
            else
            {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b5_2d_konfig_renders'].")";
            }?> </option>
        <?php
            }
        }

        if(((substr($prod_id,1)>1561)&&(substr($prod_id,1)<1566))||((substr($prod_id,1)>1581)&&(substr($prod_id,1)<1590)))
        {
    ...
    ?>
        ...
        if(!empty($all_creators[$i]['c_last_name']))
        {
            echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b5_render_slideshow'].")";
        }
        else
        {
            echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b5_render_slideshow'].")";
        }?> <?php 
