...
<div class="row mx-0 w-100 exterior">
    <div class="row mx-0 w-100 py-2">
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            <?php
            for ($k = 0;
            $k < count($b7_exterior_products_with_extensions);
            $k++)
            {
            $product = $prod->get_product($b7_exterior_products_with_extensions[$k]['prod_id']);

            if (($k > 0) && ($b7_exterior_products_with_extensions[$k - 1]['osub_id'] != $b7_exterior_products_with_extensions[$k]['osub_id']))
            {
            $global_column_count++;
            ?>
        </div> <!-- end one column -->
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            ...
            if ($b7_exterior_products_with_extensions[$k]['om_id'] != 0) {
                echo "red-border";
            } ?>">
                <div id="row<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id']; ?>">
                    <div class="row w-100 mx-0 py-2 <?php
                    for ($i = 0; $i < count($allstatus); $i++) {
                        if ($allstatus[$i]['ost_id'] == $b7_exterior_products_with_extensions[$k]['p_status']) {
                            echo $allstatus[$i]['ost_color'];
                        }
                    } ?>"
                         id="task<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id']; ?>">
                        <div id="fileuploader_<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id']; ?>">
                        </div>
                        <div class="col-4 my-1 text-center">
                            <div class="file-name p-2 bg-light text-dark">
                                <p class="text-danger mb-0"><strong><?php
                                        if ($b7_exterior_products_with_extensions[$k]['om_id'] == 0) {
                                            echo $b7_exterior_products_with_extensions[$k]['o_id'] . "." . $b7_exterior_products_with_extensions[$k]['osub_id'] . "." . $b7_exterior_products_with_extensions[$k]['prod_id'];
                                        } else {
                                            echo $b7_exterior_products_with_extensions[$k]['om_id'] . "." . $b7_exterior_products_with_extensions[$k]['osub_id'] . "." . $b7_exterior_products_with_extensions[$k]['prod_id'] . "." . $b7_exterior_products_with_extensions[$k]['o_id'];
                                        } ?></strong></p>
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                $("#fileuploader_<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?>").uploadFile({
                                    url: "../upload_file.php?filecategory=creatorfiles&o_id=<?php echo $b7_exterior_products_with_extensions[$k]['o_id'];?>&osub_id=<?php echo $b7_exterior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b7_exterior_products_with_extensions[$k]['prod_id'];?>&uca_id=<?php echo $_SESSION['client_id']; ?>",
                                    fileName: "myfile",
                                    showAbort: true,
                            ...
                            <div class="row mx-0">
                                <div class="col-12 col-xl-6 my-1 d-flex justify-content-center">
                                    ...
                                    for ($c = 0; $c < count($customer_files); $c++) {
                                        $osub_id = substr($b7_exterior_products_with_extensions[$k]['osub_id'], 1);
                                    ...
                                    <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                                        <div class="form-group align-self-center mb-0 d-flex w-100">
                                            <select name="creators_<?php echo $global_creator_counter; ?>"
                                                    ...
                                                    class="col-7 form-control form-control-sm align-self-center">
                                                ...
                                                $selected_creator = $prod->get_client($b7_exterior_products_with_extensions[$k]['uca_id']);
                                                ...
                                                if ($creator_right['u_status'] == "active") {
                                                    ?>
                                                    <option id="creator_<?php echo $b7_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                            class="offline" data-creator_task_count="<?php
                                                    $count_working_tasks = $prod->count_working_tasks($b7_exterior_products_with_extensions[$k]['uca_id']);
                                                    echo count($count_working_tasks); ?>"
                                                            value="<?php echo $b7_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                            selected><?php
                                                        if (!empty($selected_creator['c_last_name'])) {
                                                            echo $selected_creator['c_first_name'] . " " . $selected_creator['c_last_name'] . " (" . $creator_qualification['b7_walls'] . ")(" . $creator_qualification['b7_windows_doors'] . ")";
                                                            echo " - left: - next: ";
                                                        } else {
                                                            echo $selected_creator['l_first_name'] . " " . $selected_creator['l_last_name'] . " (" . $creator_qualification['b7_walls'] . ")(" . $creator_qualification['b7_windows_doors'] . ")";
                                                            echo " - left: - next: ";
                                                        } ?> </option>
                                                    <?php
                                                }
                                                ...
                                                $(document).ready(function () {
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("click", function () {
                                                        ...
                                                        if (counter == 0) {
                                                            ...
                                                            $.ajax({
                                                                url: "coordination_choose_b7_ex_creators.php",
                                                                method: "get",
                                                                data: {
                                                                    o_id:<?php echo $b7_exterior_products_with_extensions[$k]['o_id'];?>,
                                                                    osub_id: "<?php echo $b7_exterior_products_with_extensions[$k]['osub_id'];?>",
                                                                    prod_id: "<?php echo $b7_exterior_products_with_extensions[$k]['prod_id'];?>"
                                                                },
                                                                dataType: "html",
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("change", function () {
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                console.log(data);
                                                                $('#task<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 blue');
                                                                $('#product_status<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?>').val(2);
                                                            }
                                                        });
                                                    });
                                                });
                                            </script>
                                            <a href="taskdetails.php?o_id=<?php echo $b7_exterior_products_with_extensions[$k]['o_id']; ?>&osub_id=<?php echo $b7_exterior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b7_exterior_products_with_extensions[$k]['prod_id']; ?>"
                                ...
                                <div class="col-6">
                                    <div class="form-group align-self-center mb-0">
                                        <select class="form-control form-control-sm" name=""
                                                data-osub_id="<?php echo $b7_exterior_products_with_extensions[$k]['osub_id']; ?>"
                                                data-prod_id="<?php echo $b7_exterior_products_with_extensions[$k]['prod_id']; ?>"
                                                id="product_status<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id']; ?>">
                                            <?php
                                            for ($j = 1; $j < count($allstatus); $j++) {
                                                ?>
                                                <option value="<?php echo $allstatus[$j]['ost_id']; ?>"
                                                        data-status="<?php echo $allstatus[$j]['ost_color']; ?>" <?php echo ($allstatus[$j]['ost_id'] == $b7_exterior_products_with_extensions[$k]['p_status']) ? "selected" : ""; ?>><?php echo ucfirst($allstatus[$j]['ost_name']); ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                        <script type="text/javascript">
                                            $('#product_status<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?>').on("change", function () {
                                                var collection = $('#collection').val().split(";");
                                                var current_osub_id = $('#product_status<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?>').data('osub_id');
                                                var current_o_id =<?php echo $b7_exterior_products_with_extensions[$k]['o_id'];?>;
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (return_data) {
                                                        if (return_data.trim() != "no_result_files") {
                                                            var status = $('#product_status<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?>').val();
                                                            var clasa = $('#product_status<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?> option:selected').data('status');

                                                            $('#task<?php echo $b7_exterior_products_with_extensions[$k]['o_id'] . "_" . $b7_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b7_exterior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 ' + clasa);
                                                        } else {
                                ...
                                <div class="col-6 text-center">
                                    <p class="mb-0">labc: <?php
                                        ...
                                        if ((substr($b7_exterior_products_with_extensions[$k]['prod_id'], 1) > 1759) && (substr($b7_exterior_products_with_extensions[$k]['prod_id'], 1) < 1790) || ($b7_exterior_products_with_extensions[$k]['prod_id'] == "p176x") || ($b7_exterior_products_with_extensions[$k]['prod_id'] == "p176z") || ($b7_exterior_products_with_extensions[$k]['prod_id'] == "p176y")) {
                                            $o_desc_ex_b7 = $prod->get_o_desc_ex_b7($b7_exterior_products_with_extensions[$k]['o_id']);

                                            $thisproductlabc = $prod->calculateProductlabc($b7_exterior_products_with_extensions[$k]['prod_id']);

                                            if ($b7_exterior_products_with_extensions[$k]['prod_id'] == "p1761") {
                                            ...
                                            } elseif ($b7_exterior_products_with_extensions[$k]['prod_id'] == "p1763") {
                                            ...
                                            } elseif ($b7_exterior_products_with_extensions[$k]['prod_id'] == "p1766") {
                        ...
                        <?php
                        $activity = $prod->get_product_last_change($b7_exterior_products_with_extensions[$k]['o_id'], $b7_exterior_products_with_extensions[$k]['osub_id'], $b7_exterior_products_with_extensions[$k]['prod_id']);
                ...
                <?php
                if ($b7_exterior_products_with_extensions[$k]['om_id'] != 0) {
                    $result_files = $prod->show_results($b7_exterior_products_with_extensions[$k]['o_id'], $b7_exterior_products_with_extensions[$k]['osub_id'], $b7_exterior_products_with_extensions[$k]['prod_id']);
                } else {
                    $result_files = $prod->show_results($o_id, $b7_exterior_products_with_extensions[$k]['osub_id'], $b7_exterior_products_with_extensions[$k]['prod_id']);
                }
                    ...
                    if ($result_files[$i]['orf_status'] == 6) {
                            ...
                            <div class="w-100 d-flex justify-content-center">
                                <div class="form-group mb-0">
                                    <select name="result_files_visibility<?php echo $result_files[$i]['orf_id']; ?>"
                                        ...
                                        <?php
                                        if (($result_files[$i]['prod_id'] != "p176y") && ($result_files[$i]['prod_id'] != "p176z")) {
                                            ?>
                                ...
                                <?php
                                if ($result_files[$i]['prod_id'] == "p1790") {
                                    ?>
                                    <a href="<?php echo $base_url . "result_files/" . $result_files[$i]['orf_path_dom'] . $result_files[$i]['orf_internal_name_dom']; ?>"
                                       class="btn btn-sm btn-primary align-self-center ml-1" target="_blank">View
                                        Virtual Reality</a>
                                    <?php
                                } else {
                                    ?>
                        ...
                        <div class="col-6 px-2 py-0">
                            <p class="my-0 d-flex" style="font-size:12px;">
                                ...
                                <?php
                                if ($result_files[$i]['prod_id'] == "p176y") {
                                    ?>
                                ...
                                if ($result_files[$i]['prod_id'] == "p176z") {
                                    ?>
                                    <datalist id="img_categ2_<?php echo $result_files[$i]['orf_id']; ?>"
                                              data-id1="<?php echo $result_files[$i]['orf_id']; ?>">
                                ...
                                if (($result_files[$i]['prod_id'] == "p1763") || ($result_files[$i]['prod_id'] == "p1783")) {
                                    ?>
                                    <datalist id="img_categ2_<?php echo $result_files[$i]['orf_id']; ?>"
                                              data-id1="<?php echo $result_files[$i]['orf_id']; ?>">
