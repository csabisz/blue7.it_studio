...
<div class="row mx-0 w-100 interiordetails">
    <div class="row mx-0 w-100 py-2">
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            <?php
            for ($k = 0;
            $k < count($b7_interior_products_with_extensions);
            $k++)
            {
            $product = $prod->get_product($b7_interior_products_with_extensions[$k]['prod_id']);

            if (($k > 0) && ($b7_interior_products_with_extensions[$k - 1]['osub_id'] != $b7_interior_products_with_extensions[$k]['osub_id']))
            {
            $global_column_count++;
            ?>
        </div> <!-- end one column -->
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            ...
            if ($b7_interior_products_with_extensions[$k]['om_id'] != 0) {
                echo "red-border";
            } ?>">
                <div id="row<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id']; ?>">
                    <div class="row w-100 mx-0 py-2 <?php
                    for ($i = 0; $i < count($allstatus); $i++) {
                        if ($allstatus[$i]['ost_id'] == $b7_interior_products_with_extensions[$k]['p_status']) {
                            echo $allstatus[$i]['ost_color'];
                        }
                    } ?>"
                         id="task<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id']; ?>">
                        <div id="fileuploader_<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id']; ?>">
                        </div>
                        <div class="col-4 my-1 text-center">
                            <div class="file-name p-2 bg-light text-dark">
                                <p class="text-danger mb-0"><strong><?php
                                        if ($b7_interior_products_with_extensions[$k]['om_id'] == 0) {
                                            echo $b7_interior_products_with_extensions[$k]['o_id'] . "." . $b7_interior_products_with_extensions[$k]['osub_id'] . "." . $b7_interior_products_with_extensions[$k]['prod_id'];
                                        } else {
                                            echo $b7_interior_products_with_extensions[$k]['om_id'] . "." . $b7_interior_products_with_extensions[$k]['osub_id'] . "." . $b7_interior_products_with_extensions[$k]['prod_id'] . "." . $b7_interior_products_with_extensions[$k]['o_id'];
                                        } ?></strong></p>
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                $("#fileuploader_<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>").uploadFile({
                                    url: "../upload_file.php?filecategory=creatorfiles&o_id=<?php echo $b7_interior_products_with_extensions[$k]['o_id'];?>&osub_id=<?php echo $b7_interior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b7_interior_products_with_extensions[$k]['prod_id'];?>&uca_id=<?php echo $_SESSION['client_id']; ?>",
                                    fileName: "myfile",
                                    showAbort: true,
                            ...
                            <div class="row mx-0">
                                <div class="col-12 col-xl-6 my-1 d-flex justify-content-center">
                                    ...
                                    for ($c = 0; $c < count($customer_files); $c++) {
                                        $osub_id = substr($b7_interior_products_with_extensions[$k]['osub_id'], 1);
                                    ...
                                    <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                                        <div class="form-group align-self-center mb-0 d-flex">
                                            <select name="creators_<?php echo $global_creator_counter; ?>"
                                                    data-prod_id="<?php echo $b7_interior_products_with_extensions[$k]['prod_id']; ?>"
                                                ...
                                                $selected_creator = $prod->get_client($b7_interior_products_with_extensions[$k]['uca_id']);
                                                ...
                                                if ($creator_right['u_status'] == "active") {
                                                    ?>
                                                    <option id="creator_<?php echo $b7_interior_products_with_extensions[$k]['uca_id']; ?>"
                                                            class="offline" data-creator_task_count="<?php
                                                    $count_working_tasks = $prod->count_working_tasks($b7_interior_products_with_extensions[$k]['uca_id']);
                                                    echo count($count_working_tasks); ?>"
                                                            value="<?php echo $b7_interior_products_with_extensions[$k]['uca_id']; ?>"
                                                            selected><?php
                                                ...
                                                $(document).ready(function () {
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("click", function () {
                                                        ...
                                                        if (counter == 0) {
                                                            ...
                                                            $.ajax({
                                                                url: "coordination_choose_b7_in_creators.php",
                                                                method: "get",
                                                                data: {
                                                                    o_id:<?php echo $b7_interior_products_with_extensions[$k]['o_id'];?>,
                                                                    osub_id: "<?php echo $b7_interior_products_with_extensions[$k]['osub_id'];?>",
                                                                    prod_id: "<?php echo $b7_interior_products_with_extensions[$k]['prod_id'];?>"
                                                                },
                                                                dataType: "html",
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("change", function () {
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                //console.log(data);
                                                                if (($('#creators_<?php echo $global_creator_counter;?>').data("prod_id") == "p1700") || ($('#creators_<?php echo $global_creator_counter;?>').data("prod_id") == "p1701")) {
                                                                    $('#task<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 d-flex justify-content-center dark-green');
                                                                    $('#product_status<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').val(4);
                                                                } else {
                                                                    $('#task<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 d-flex justify-content-center blue');
                                                                    $('#product_status<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').val(2);
                                                                }
                                                            }
                                                        });
                                                    });
                                            ...
                                            <a href="taskdetails.php?o_id=<?php echo $b7_interior_products_with_extensions[$k]['o_id']; ?>&osub_id=<?php echo $b7_interior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b7_interior_products_with_extensions[$k]['prod_id']; ?>"
                                               class="btn btn-sm btn-primary align-self-center mx-1">Details</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group align-self-center mb-0">
                                        <select class="form-control form-control-sm" name=""
                                                data-osub_id="<?php echo $b7_interior_products_with_extensions[$k]['osub_id']; ?>"
                                                data-prod_id="<?php echo $b7_interior_products_with_extensions[$k]['prod_id']; ?>"
                                                id="product_status<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id']; ?>">
                                            <?php
                                            for ($j = 1; $j < count($allstatus); $j++) {
                                                ?>
                                                <option value="<?php echo $allstatus[$j]['ost_id']; ?>"
                                                        data-status="<?php echo $allstatus[$j]['ost_color']; ?>" <?php echo ($allstatus[$j]['ost_id'] == $b7_interior_products_with_extensions[$k]['p_status']) ? "selected" : ""; ?>><?php echo ucfirst($allstatus[$j]['ost_name']); ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                        <script type="text/javascript">
                                            $('#product_status<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').on("change", function () {
                                                var collection = $('#collection').val().split(";");
                                                var current_osub_id = $('#product_status<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').data('osub_id');
                                                var current_o_id =<?php echo $b7_interior_products_with_extensions[$k]['o_id'];?>;
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (return_data) {
                                                        if (return_data.trim() != "no_result_files") {
                                                            var status = $('#product_status<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').val();
                                                            var clasa = $('#product_status<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?> option:selected').data('status');
                                                            $('#task<?php echo $b7_interior_products_with_extensions[$k]['o_id'] . "_" . $b7_interior_products_with_extensions[$k]['osub_id'] . "_" . $b7_interior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 ' + clasa);
                                                        } else {
                                ...
                                <div class="col-6 text-center">
                                    <p class="mb-0">labc: <?php
                                        if ((substr($b7_interior_products_with_extensions[$k]['prod_id'], 1) > 1699) && (substr($b7_interior_products_with_extensions[$k]['prod_id'], 1) < 1760)) {
                                            //calculating b7 interior labc
                                            $o_desc_in_b7 = $prod->get_o_desc_in_b7($b7_interior_products_with_extensions[$k]['o_id']);

                                            $thisproductlabc = $prod->calculateProductlabc($b7_interior_products_with_extensions[$k]['prod_id']);

                                            if ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1700") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1701") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1704") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1721") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1724") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1741") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1744") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1706") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1726") {
                                            ...
                                            } elseif ($b7_interior_products_with_extensions[$k]['prod_id'] == "p1746") {
                        ...
                        <?php
                        $activity = $prod->get_product_last_change($b7_interior_products_with_extensions[$k]['o_id'], $b7_interior_products_with_extensions[$k]['osub_id'], $b7_interior_products_with_extensions[$k]['prod_id']);
                ...
                <?php
                if ($b7_interior_products_with_extensions[$k]['om_id'] != 0) {
                    $result_files = $prod->show_results($b7_interior_products_with_extensions[$k]['o_id'], $b7_interior_products_with_extensions[$k]['osub_id'], $b7_interior_products_with_extensions[$k]['prod_id']);
                } else {
                    $result_files = $prod->show_results($o_id, $b7_interior_products_with_extensions[$k]['osub_id'], $b7_interior_products_with_extensions[$k]['prod_id']);
                }
                        ...
                        <div class="col-6 px-0 py-2 text-center d-flex align-items-start">
                            <div class="row mx-0 w-100 d-flex justify-content-center align-items-start">
                                ...
                                <div class="col-2 p-0 d-flex align-items-center">
                                    ...
                                    {
                                    if (($result_files[$i]['prod_id'] == "p1706") || ($result_files[$i]['prod_id'] == "p1726") || ($result_files[$i]['prod_id'] == "p1746") || ($result_files[$i]['prod_id'] == "p1766"))
                                    {
                                    ?>
                                    <style>
