                                        ...
                                        ?>
                                            ...
                                            <div id="image_tooltip_container_<?php echo $image_preview_counter; ?>">
                                                ...
                                                <a href="https://bauvorschau.com/index.php/images/optimized/100/1000/<?php echo $result_files[$i]['orf_path_dom'].$result_files[$i]['orf_internal_name_dom']; ?>" target="_blank"><img src="../result_thumbnail_files/<?php echo $result_files[$i]['orf_thumbnail_path']; ?>"
                                                    ...
                                                    <a href="https://bauvorschau.com/index.php/images/optimized/100/1000/<?php echo $result_files[$i]['orf_path_dom'].$result_files[$i]['orf_internal_name_dom']; ?>" target="_blank"><img class="img-fluid"
                                                            src="../result_files/<?php echo $result_files[$i]['orf_path_dom'] . $result_files[$i]['orf_internal_name_dom']; ?>"
                                                            alt="<?php echo $result_files[$i]['orf_name']; ?>"
                                                            width="60" heigth="33.78" class="d-inline"></a>
