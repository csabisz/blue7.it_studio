...
<div class="row mx-0 w-100 interiordetails">
    ...
    <div class="row mx-0 w-100 py-2">
        ...
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            ...
            for ($k = 0;
            $k < count($b6_interior_products_with_extensions);
            $k++)

            {

            $product = $prod->get_product($b6_interior_products_with_extensions[$k]['prod_id']);


            if (($k > 0) && ($b6_interior_products_with_extensions[$k - 1]['osub_id'] != $b6_interior_products_with_extensions[$k]['osub_id']))
        ...
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            ...
            if ($b6_interior_products_with_extensions[$k]['om_id'] != 0) {

                echo "red-border";

            } ?>">

                <div id="row<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id']; ?>">

                    <div class="row w-100 mx-0 py-2 <?php

                    for ($i = 0; $i < count($allstatus); $i++) {

                        if ($allstatus[$i]['ost_id'] == $b6_interior_products_with_extensions[$k]['p_status']) {
                         ...
                         id="task<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id']; ?>">

                        <div id="fileuploader_<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id']; ?>">
                            ...
                            <div class="file-name p-2 bg-light text-dark">
                                ...
                                <p class="text-danger mb-0"><strong><?php
                                        ...
                                        if ($b6_interior_products_with_extensions[$k]['om_id'] == 0) {
                                            ...
                                            echo $b6_interior_products_with_extensions[$k]['o_id'] . "." . $b6_interior_products_with_extensions[$k]['osub_id'] . "." . $b6_interior_products_with_extensions[$k]['prod_id'];

                                        } else {

                                            echo $b6_interior_products_with_extensions[$k]['om_id'] . "." . $b6_interior_products_with_extensions[$k]['osub_id'] . "." . $b6_interior_products_with_extensions[$k]['prod_id'] . "." . $b6_interior_products_with_extensions[$k]['o_id'];
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function () {
                                ...
                                $("#fileuploader_<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>").uploadFile({

                                    url: "../upload_file.php?filecategory=creatorfiles&o_id=<?php echo $b6_interior_products_with_extensions[$k]['o_id'];?>&osub_id=<?php echo $b6_interior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b6_interior_products_with_extensions[$k]['prod_id'];?>&uca_id=<?php echo $_SESSION['client_id']; ?>",
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-12 col-xl-6 my-1 d-flex justify-content-center">
                                    ...
                                    for ($c = 0; $c < count($customer_files); $c++) {
                                        ...
                                        $osub_id = substr($b6_interior_products_with_extensions[$k]['osub_id'], 1);
                                    ...
                                    <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                                        ...
                                        <div class="form-group align-self-center mb-0 w-100 d-flex">
                                            ...
                                            <select name="creators_<?php echo $global_creator_counter; ?>"
                                                    data-prod_id="<?php echo $b6_interior_products_with_extensions[$k]['prod_id']; ?>"
                                                    id="creators_<?php echo $global_creator_counter; ?>"
                                                    data-selected_creator="<?php echo $b6_interior_products_with_extensions[$k]['uca_id']; ?>"
                                                ...
                                                $selected_creator = $prod->get_client($b6_interior_products_with_extensions[$k]['uca_id']);
                                                ...
                                                if ($creator_right['u_status'] == "active") {
                                                    ...
                                                    <option id="creator_<?php echo $b6_interior_products_with_extensions[$k]['uca_id']; ?>"
                                                            class="walls_windows_creator_task_count offline"
                                                            data-creator_task_count="<?php

                                                            $count_working_tasks = $prod->count_working_tasks($b6_interior_products_with_extensions[$k]['uca_id']);

                                                            echo count($count_working_tasks); ?>"
                                                            value="<?php echo $b6_interior_products_with_extensions[$k]['uca_id']; ?>"
                                                            selected><?php

                                                        if (!empty($selected_creator['c_last_name'])) {

                                                            echo $selected_creator['c_first_name'] . " " . $selected_creator['c_last_name'] . " (" . $creator_qualification['b6_walls'] . ")(" . $creator_qualification['b6_windows_doors'] . ")";

                                                            echo " - left: - next: ";

                                                        } else {

                                                            echo $selected_creator['l_first_name'] . " " . $selected_creator['l_last_name'] . " (" . $creator_qualification['b6_walls'] . ")(" . $creator_qualification['b6_windows_doors'] . ")";
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("click", function () {
                                                        ...
                                                        if (counter == 0) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url: "coordination_choose_b6_in_creators.php",

                                                                method: "get",

                                                                data: {
                                                                    o_id:<?php echo $b6_interior_products_with_extensions[$k]['o_id'];?>,
                                                                    osub_id: "<?php echo $b6_interior_products_with_extensions[$k]['osub_id'];?>",
                                                                    prod_id: "<?php echo $b6_interior_products_with_extensions[$k]['prod_id'];?>"
                                                                },
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("change", function () {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                ...
                                                                if (($('#creators_<?php echo $global_creator_counter;?>').data("prod_id") == "p1600") || ($('#creators_<?php echo $global_creator_counter;?>').data("prod_id") == "p1601")) {

                                                                    $('#task<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 d-flex justify-content-center dark-green');

                                                                    $('#product_status<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').val(4);

                                                                } else {

                                                                    $('#task<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 d-flex justify-content-center blue');

                                                                    $('#product_status<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').val(2);
                                            ...
                                            <a href="taskdetails.php?o_id=<?php echo $b6_interior_products_with_extensions[$k]['o_id']; ?>&osub_id=<?php echo $b6_interior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b6_interior_products_with_extensions[$k]['prod_id']; ?>"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group align-self-center mb-0">
                                        ...
                                        <select class="form-control form-control-sm" name=""
                                                data-osub_id="<?php echo $b6_interior_products_with_extensions[$k]['osub_id']; ?>"
                                                data-prod_id="<?php echo $b6_interior_products_with_extensions[$k]['prod_id']; ?>"
                                                id="product_status<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id']; ?>">
                                            ...
                                            for ($j = 1; $j < count($allstatus); $j++) {
                                                ...
                                                <option value="<?php echo $allstatus[$j]['ost_id']; ?>"
                                                        data-status="<?php echo $allstatus[$j]['ost_color']; ?>" <?php echo ($allstatus[$j]['ost_id'] == $b6_interior_products_with_extensions[$k]['p_status']) ? "selected" : ""; ?>><?php echo ucfirst($allstatus[$j]['ost_name']); ?></option>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            $('#product_status<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').on("change", function () {

                                                var collection = $('#collection').val().split(";");

                                                var current_osub_id = $('#product_status<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').data('osub_id');

                                                var current_o_id =<?php echo $b6_interior_products_with_extensions[$k]['o_id'];?>;
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (return_data) {
                                                        ...
                                                        if (return_data.trim() != "no_result_files") {
                                                            ...
                                                            var status = $('#product_status<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').val();

                                                            var clasa = $('#product_status<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?> option:selected').data('status');


                                                            $('#task<?php echo $b6_interior_products_with_extensions[$k]['o_id'] . "_" . $b6_interior_products_with_extensions[$k]['osub_id'] . "_" . $b6_interior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 ' + clasa);
                                ...
                                if ($b6_interior_products_with_extensions[$k]['om_id'] != 0) {
                                    ...
                                    $result_files = $prod->show_results($b6_interior_products_with_extensions[$k]['o_id'], $b6_interior_products_with_extensions[$k]['osub_id'], $b6_interior_products_with_extensions[$k]['prod_id']);

                                } else {

                                    $result_files = $prod->show_results($o_id, $b6_interior_products_with_extensions[$k]['osub_id'], $b6_interior_products_with_extensions[$k]['prod_id']);
                                ...
                                $counter_visible_files_for_user = 0;

                                for ($i = 0; $i < count($result_files); $i++) {

                                    if ($result_files[$i]['orf_status'] == 8) $counter_visible_files_for_user++;
                                ...
                                <div class="col-6 text-center">
                                    ...
                                    <p class="mb-0">labc: <?php
                                        ...
                                        if ((substr($b6_interior_products_with_extensions[$k]['prod_id'], 1) > 1599) && (substr($b6_interior_products_with_extensions[$k]['prod_id'], 1) < 1660)) {

                                            $o_desc_in_b6 = $prod->get_o_desc_in_b6($b6_interior_products_with_extensions[$k]['o_id']);

                                            $thisproductlabc = $prod->calculateProductlabc($b6_interior_products_with_extensions[$k]['prod_id']);

                                            if ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1621") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1624") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1626") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1600") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1601") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1604") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1641") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1644") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1606") {
                                            ...
                                            } elseif ($b6_interior_products_with_extensions[$k]['prod_id'] == "p1646") {
                        ...
                        $activity = $prod->get_product_last_change($b6_interior_products_with_extensions[$k]['o_id'], $b6_interior_products_with_extensions[$k]['osub_id'], $b6_interior_products_with_extensions[$k]['prod_id']);
                ...
                <pre class="text-center">
                    ...
                    // print_r($result_files[0]['orf_status']=="8") ;

                    // echo $counter_visible_files_for_user;

                    // print_r($result_files) ;

                    // echo count($result_files['orf_status']==8);
                ...
                for ($i = 0; $i < count($result_files); $i++) {
                    ...
                    <div class="row w-100 mx-0 border-top border-white <?php echo ($result_files[$i]['orf_status'] == 0) ? "grey-dark" : "light-green"; ?>"
                        ...
                        <div class="col-6 px-0 py-2 text-center d-flex align-items-start">
                            ...
                            <div class="row mx-0 w-100 d-flex justify-content-start">

                                <div class="col-10 px-0 d-flex align-items-start flex-row">

                                    <div class="justify-content-center w-100">

                                        <div class="file-name w-100 d-flex flex-column justify-content-center">
                                            ...
                                            <div class="row w-100 mx-0 px-0 d-flex justify-content-center">
                                                <button id="rename_btn<?php echo $result_files[$i]['orf_id'] ?>"
                                                        class="btn btn-sm btn-primary mt-0 d-inline rounded-0"
                                ...
                                <div class="col-2 p-0 d-flex align-items-center">
                                    ...
                                    if (($result_files[$i]['prod_id'] == "p1606") || ($result_files[$i]['prod_id'] == "p1626") || ($result_files[$i]['prod_id'] == "p1646") || ($result_files[$i]['prod_id'] == "p1666"))
                                    ...
                                    <a href="https://bauvorschau.com/index.php/images/optimized/100/1000/<?php echo $result_files[$i]['orf_path_dom'].$result_files[$i]['orf_internal_name_dom']; ?>" target="_blank"><img data-toggle="modal"
                                            data-target="#pic360_<?php echo $image_preview_counter; ?>"
                                            src="../result_thumbnail_files/<?php echo $result_files[$i]['orf_thumbnail_path']; ?>"
                                            alt="<?php echo $result_files[$i]['orf_name']; ?>" width="60" heigth="33.78"
                                        ...
                                        <a href="https://bauvorschau.com/index.php/images/optimized/100/1000/<?php echo $result_files[$i]['orf_path_dom'].$result_files[$i]['orf_internal_name_dom']; ?>" target="_blank"><img data-toggle="modal"
                                                ...
                                                alt="<?php echo $result_files[$i]['orf_name']; ?>" width="60"
                                                heigth="33.78" class="img-responsive d-inline img-fluid"></a>
                                            ...
                                            <div class="modal fade" id="pic360_<?php echo $image_preview_counter; ?>"
                                            ...
                                            <?php
                                                ...
                                                <div id="image_tooltip_container_<?php echo $image_preview_counter; ?>">
                                                    ...
                                                    if (!empty($result_files[$i]['orf_thumbnail_path'])) {
                                                        ...
                                                        <a href="https://bauvorschau.com/index.php/images/optimized/100/1000/<?php echo $result_files[$i]['orf_path_dom'].$result_files[$i]['orf_internal_name_dom']; ?>" target="_blank"><img src="../result_thumbnail_files/<?php echo $result_files[$i]['orf_thumbnail_path']; ?>"
                                                             alt="<?php echo $result_files[$i]['orf_name']; ?>"
                                                             width="60" heigth="33.78"
                                                             class="d-inline img-fluid img-responsive"></a>
                                                        ...
                                                        <a href="https://bauvorschau.com/index.php/images/optimized/100/1000/<?php echo $result_files[$i]['orf_path_dom'].$result_files[$i]['orf_internal_name_dom']; ?>" target="_blank"><img src="../result_files/<?php echo $result_files[$i]['orf_path_dom'] . $result_files[$i]['orf_internal_name_dom']; ?>"
                                                             alt="<?php echo $result_files[$i]['orf_name']; ?>"
                                                             width="60" heigth="33.78"
                                                             class="d-inline img-fluid img-responsive"></a>
