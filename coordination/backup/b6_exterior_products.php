...
<div class="row mx-0 w-100 exterior">
    ...
    <div class="row mx-0 w-100 py-2">
        ...
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            ...
            for ($k = 0;
            $k < count($b6_exterior_products_with_extensions);
            $k++)

            {

            $product = $prod->get_product($b6_exterior_products_with_extensions[$k]['prod_id']);


            if (($k > 0) && ($b6_exterior_products_with_extensions[$k - 1]['osub_id'] != $b6_exterior_products_with_extensions[$k]['osub_id']))
        ...
        <div class="col-12 my-2 col-lg-4" style="border-bottom:2px solid #000;"> <!-- start one column -->
            ...
            if ($b6_exterior_products_with_extensions[$k]['om_id'] != 0) {

                echo "red-border";

            } ?>">

                <div id="row<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id']; ?>">

                    <div class="row w-100 mx-0 py-2 <?php

                    for ($i = 0; $i < count($allstatus); $i++) {

                        if ($allstatus[$i]['ost_id'] == $b6_exterior_products_with_extensions[$k]['p_status']) {
                         ...
                         id="task<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id']; ?>">

                        <div id="fileuploader_<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id']; ?>">
                            ...
                            <div class="file-name p-2 bg-light text-dark">
                                ...
                                <p class="text-danger mb-0"><strong><?php
                                        ...
                                        if ($b6_exterior_products_with_extensions[$k]['om_id'] == 0) {
                                            ...
                                            echo $b6_exterior_products_with_extensions[$k]['o_id'] . "." . $b6_exterior_products_with_extensions[$k]['osub_id'] . "." . $b6_exterior_products_with_extensions[$k]['prod_id'];

                                        } else {

                                            echo $b6_exterior_products_with_extensions[$k]['om_id'] . "." . $b6_exterior_products_with_extensions[$k]['osub_id'] . "." . $b6_exterior_products_with_extensions[$k]['prod_id'] . "." . $b6_exterior_products_with_extensions[$k]['o_id'];
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function () {
                                ...
                                $("#fileuploader_<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?>").uploadFile({

                                    url: "../upload_file.php?filecategory=creatorfiles&o_id=<?php echo $b6_exterior_products_with_extensions[$k]['o_id'];?>&osub_id=<?php echo $b6_exterior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b6_exterior_products_with_extensions[$k]['prod_id'];?>&uca_id=<?php echo $_SESSION['client_id']; ?>",
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-12 col-xl-6 my-1 d-flex justify-content-center">
                                    ...
                                    for ($c = 0; $c < count($customer_files); $c++) {
                                        ...
                                        $osub_id = substr($b6_exterior_products_with_extensions[$k]['osub_id'], 1);
                                    ...
                                    <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                                        ...
                                        <div class="form-group align-self-center mb-0 w-100 d-flex">
                                            ...
                                            <select name="creators_<?php echo $global_creator_counter; ?>"
                                                    ...
                                                    data-selected_creator="<?php echo $b6_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                ...
                                                $selected_creator = $prod->get_client($b6_exterior_products_with_extensions[$k]['uca_id']);
                                                ...
                                                if ($creator_right['u_status'] == "active") {
                                                    ...
                                                    <option id="creator_<?php echo $b6_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                            class="offline" data-creator_task_count="<?php

                                                    $count_working_tasks = $prod->count_working_tasks($b6_exterior_products_with_extensions[$k]['uca_id']);

                                                    echo count($count_working_tasks); ?>"
                                                            value="<?php echo $b6_exterior_products_with_extensions[$k]['uca_id']; ?>"
                                                            selected><?php
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("click", function () {
                                                        ...
                                                        if (counter == 0) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url: "coordination_choose_b6_ex_creators.php",

                                                                method: "get",

                                                                data: {
                                                                    o_id:<?php echo $b6_exterior_products_with_extensions[$k]['o_id'];?>,
                                                                    osub_id: "<?php echo $b6_exterior_products_with_extensions[$k]['osub_id'];?>",
                                                                    prod_id: "<?php echo $b6_exterior_products_with_extensions[$k]['prod_id'];?>"
                                                                },
                                                    ...
                                                    $('#creators_<?php echo $global_creator_counter;?>').on("change", function () {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                ...
                                                                $('#task<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 blue');

                                                                $('#product_status<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?>').val(2);
                                            ...
                                            <a href="taskdetails.php?o_id=<?php echo $b6_exterior_products_with_extensions[$k]['o_id']; ?>&osub_id=<?php echo $b6_exterior_products_with_extensions[$k]['osub_id']; ?>&prod_id=<?php echo $b6_exterior_products_with_extensions[$k]['prod_id']; ?>"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group align-self-center mb-0">
                                        ...
                                        <select class="form-control form-control-sm" name=""
                                                data-osub_id="<?php echo $b6_exterior_products_with_extensions[$k]['osub_id']; ?>"
                                                data-prod_id="<?php echo $b6_exterior_products_with_extensions[$k]['prod_id']; ?>"
                                                id="product_status<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id']; ?>">
                                            ...
                                            for ($j = 1; $j < count($allstatus); $j++) {
                                                ...
                                                <option value="<?php echo $allstatus[$j]['ost_id']; ?>"
                                                        data-status="<?php echo $allstatus[$j]['ost_color']; ?>" <?php echo ($allstatus[$j]['ost_id'] == $b6_exterior_products_with_extensions[$k]['p_status']) ? "selected" : ""; ?>><?php echo ucfirst($allstatus[$j]['ost_name']); ?></option>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            $('#product_status<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?>').on("change", function () {

                                                var collection = $('#collection').val().split(";");

                                                var current_osub_id = $('#product_status<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?>').data('osub_id');

                                                var current_o_id =<?php echo $b6_exterior_products_with_extensions[$k]['o_id'];?>;
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (return_data) {
                                                        ...
                                                        if (return_data.trim() != "no_result_files") {
                                                            ...
                                                            var status = $('#product_status<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?>').val();

                                                            var clasa = $('#product_status<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?> option:selected').data('status');


                                                            $('#task<?php echo $b6_exterior_products_with_extensions[$k]['o_id'] . "_" . $b6_exterior_products_with_extensions[$k]['osub_id'] . "_" . $b6_exterior_products_with_extensions[$k]['prod_id'];?>').removeClass().addClass('row w-100 mx-0 py-2 ' + clasa);
                                ...
                                <div class="col-6 text-center">
                                    ...
                                    <p class="mb-0">labc: <?php
                                        ...
                                        if ((substr($b6_exterior_products_with_extensions[$k]['prod_id'], 1) > 1659) && (substr($b6_exterior_products_with_extensions[$k]['prod_id'], 1) < 1690) || ($b6_exterior_products_with_extensions[$k]['prod_id'] == "p166x") || ($b6_exterior_products_with_extensions[$k]['prod_id'] == "p166z") || ($b6_exterior_products_with_extensions[$k]['prod_id'] == "p166y")) {

                                            $o_desc_ex_b6 = $prod->get_o_desc_ex_b6($b6_exterior_products_with_extensions[$k]['o_id']);


                                            $thisproductlabc = $prod->calculateProductlabc($b6_exterior_products_with_extensions[$k]['prod_id']);


                                            if ($b6_exterior_products_with_extensions[$k]['prod_id'] == "p1661") {
                                            ...
                                            } elseif ($b6_exterior_products_with_extensions[$k]['prod_id'] == "p1663") {
                                            ...
                                            } elseif ($b6_exterior_products_with_extensions[$k]['prod_id'] == "p1666") {
                        ...
                        $activity = $prod->get_product_last_change($b6_exterior_products_with_extensions[$k]['o_id'], $b6_exterior_products_with_extensions[$k]['osub_id'], $b6_exterior_products_with_extensions[$k]['prod_id']);
                ...
                if ($b6_exterior_products_with_extensions[$k]['om_id'] != 0) {
                    ...
                    $result_files = $prod->show_results($b6_exterior_products_with_extensions[$k]['o_id'], $b6_exterior_products_with_extensions[$k]['osub_id'], $b6_exterior_products_with_extensions[$k]['prod_id']);

                } else {

                    $result_files = $prod->show_results($o_id, $b6_exterior_products_with_extensions[$k]['osub_id'], $b6_exterior_products_with_extensions[$k]['prod_id']);
                    ...
                    if ($result_files[$i]['orf_status'] == 6) {
                            ...
                            <div class="w-100 d-flex justify-content-center">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <select name="result_files_visibility<?php echo $result_files[$i]['orf_id']; ?>"
                                        ...
                                        <?php
                                        if (($result_files[$i]['prod_id'] != "p166y") && ($result_files[$i]['prod_id'] != "p166z")) {
                                            ?>
                        ...
                        <div class="col-6 px-2 py-0">
                            ...
                            <p class="my-0 d-flex" style="font-size:12px;">
                                ...
                                <?php
                                if ($result_files[$i]['prod_id'] == "p166y") {
                                    ?>
                                ...
                                if ($result_files[$i]['prod_id'] == "p166z") {
                                    ?>
                                    <datalist id="img_categ2_<?php echo $result_files[$i]['orf_id']; ?>"
                                              data-id1="<?php echo $result_files[$i]['orf_id']; ?>">
                                ...
                                if (($result_files[$i]['prod_id'] == "p1663") || ($result_files[$i]['prod_id'] == "p1683")) {
                                    ?>
                                    <datalist id="img_categ2_<?php echo $result_files[$i]['orf_id']; ?>"
                                              data-id1="<?php echo $result_files[$i]['orf_id']; ?>">
