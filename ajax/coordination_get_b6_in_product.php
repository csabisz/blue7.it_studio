                    ...
                    <div class="form-group align-self-center mb-0 w-100 d-flex">
                        ...
                        for($i=0;$i<count($all_creators);$i++)
                        {
                            ...
                            <?php
                                ...
                                if(((substr($o_prod['prod_id'],1)>1601)&&(substr($o_prod['prod_id'],1)<1606))||((substr($o_prod['prod_id'],1)>1621)&&(substr($o_prod['prod_id'],1)<1626))||((substr($o_prod['prod_id'],1)>1641)&&(substr($o_prod['prod_id'],1)<1646)))
                                {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1621")||($o_prod['prod_id']=="p1641"))
                                {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1606")||($o_prod['prod_id']=="p1626")||($o_prod['prod_id']=="p1646"))
                                {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1607")||($o_prod['prod_id']=="p1627")||($o_prod['prod_id']=="p1647"))
                                {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1608")||($o_prod['prod_id']=="p1628")||($o_prod['prod_id']=="p1648"))
                                {
                            ...
                            success:function(data) {
                                ...
                                for(p=0;p<collection.length;p++)
                                {
                                    ...
                                    if(collection[p]!="")
                                    {
                                        ...
                                        if((prod>=1600)&&(prod<1660))
                                        {
                                            $.ajax({
                                            url: "../ajax/coordination_get_b6_in_product.php",
                                            method: "get",
