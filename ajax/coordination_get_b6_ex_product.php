            ...
            <div class="col-12 col-xl-6 my-1 px-0 d-flex">
                <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                    <div class="form-group align-self-center mb-0 w-100 d-flex">
                        <select name="creators_<?php echo $global_creator_counter;?>" id="creators_<?php echo $global_creator_counter;?>" data-selected_creator="<?php echo $o_prod['uca_id'];?>" class="creator col-7 form-control form-control-sm align-self-center">
                        ...
                        for($i=0;$i<count($all_creators);$i++)
                        {
                            ...
                            <?php
                                ...
                                if(((substr($o_prod['prod_id'],1)>1661)&&(substr($o_prod['prod_id'],1)<1666))||((substr($o_prod['prod_id'],1)>1681)&&(substr($o_prod['prod_id'],1)<1690)))
                                {
                            ...
                            <?php
                                ...
                                if($o_prod['prod_id']=="p1668")
                                {
                                    if($creator_qualification['b6_vr']>0)
                                    {
                            ?>
                                <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" data-creator_task_count="<?php 
                                    $count_working_tasks=$prod->count_working_tasks($all_creators[$i]['client_ID']);
                            ...
                            ?>
                                <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" data-creator_task_count="<?php 
                                    ...
                                    if(!empty($all_creators[$i]['c_last_name']))
                                    {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b6_environment'].")";
                                    }
                                    else
                                    {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b6_environment'].")";
                                    }?> </option>
                            <?php
                                    }
                                }
                            ...
                            success:function(data) {
                                ...
                                for(p=0;p<collection.length;p++)
                                {
                                    ...
                                    if(collection[p]!="")
                                    {
                                        ...
                                        if((prod>=1660)&&(prod<1699))
                                        {
                                            $.ajax({
                                            url: "../ajax/coordination_get_b6_ex_product.php",
                                            method: "get",
