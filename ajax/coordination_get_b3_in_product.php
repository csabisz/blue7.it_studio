                        ...
                        <div class="form-group align-self-center w-100 mb-0 d-flex">
                            ...
                            for($i=0;$i<count($all_creators);$i++)
                            {
                                ...
                                <?php
                                    ...
                                    if(($o_prod['prod_id']=="p1302")||($o_prod['prod_id']=="p1322"))
                                    {
                                        if($creator_qualification['b3_furniture']>0)
                                        {
                                ?>
                                    ...
                                    success:function(data) {
                                        ...
                                        for(p=0;p<collection.length;p++)
                                        {
                                            ...
                                            if(collection[p]!="")
                                            {
                                                ...
                                                if((prod>1300)&&(prod<1360))
                                                {
                                                    $.ajax({
                                                    url: "../ajax/coordination_get_b3_in_product.php",
                                                    method: "get",
