...
$domain_homepage_url=explode('.',$prod->xss_fix($_POST['domain_homepage_url']));

if((!empty($domain_homepage_url))&&(count($domain_homepage_url)==2))
{
//$subdomain=$domain_homepage_url[0];
$domain=$domain_homepage_url[0].".".$domain_homepage_url[1];

$source_path="/home/admin/domains/bauvorschau.com/public_html/aa-p4p-template";
$destination_path="/home/admin/domains/".$domain."/public_html/";
