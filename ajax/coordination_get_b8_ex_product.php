                    ...
                    <div class="form-group align-self-center mb-0 d-flex w-100">
                        ...
                        for($i=0;$i<count($all_creators);$i++)
                        {
                            ...
                            <?php
                                ...
                                if(((substr($o_prod['prod_id'],1)>1861)&&(substr($o_prod['prod_id'],1)<1866))||((substr($o_prod['prod_id'],1)>1881)&&(substr($o_prod['prod_id'],1)<1890)))
                                {
                            ...
                            <?php
                                ...
                                if($o_prod['prod_id']=="p1866")
                                {
                                    if($creator_qualification['b8_render_360']>0)
                                    {
                            ?>
                                <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="b8_render_360_creator_task_count offline" value="<?php echo $all_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_creators[$i]['client_ID'])?"selected":""?>><?php 
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                        ...
                        for($i=0;$i<count($all_other_creators);$i++)
                        {
                            ...
                            ?>
                                <option id="creator_<?php echo $all_other_creators[$i]['client_ID']; ?>" class="b8_render_360_creator_task_count offline" value="<?php echo $all_other_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_other_creators[$i]['client_ID'])?"selected":""?>><?php 
                                if(!empty($all_other_creators[$i]['c_last_name']))
                                {
                            ...
                            success:function(data) {
                                ...
                                for(p=0;p<collection.length;p++)
                                {
                                    ...
                                    if(collection[p]!="")
                                    {
                                        ...
                                        if((prod>=1860)&&(prod<1899))
                                        {
                                            $.ajax({
                                            url: "../ajax/coordination_get_b8_ex_product.php",
                                            method: "get",
