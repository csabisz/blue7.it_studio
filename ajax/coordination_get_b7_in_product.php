            ...
            <div class="col-12 col-xl-6 my-1 px-0 d-flex">
                <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                    <div class="form-group align-self-center mb-0 d-flex">
                        <select name="creators_<?php echo $global_creator_counter;?>" data-prod_id="<?php echo $o_prod['prod_id'];?>" id="creators_<?php echo $global_creator_counter;?>" class="form-control form-control-sm align-self-center">
                        ...
                        for($i=0;$i<count($all_creators);$i++)
                        {
                            ...
                            ?>
                                ...
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_walls'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_walls'].")";
                                }?> </option>
                            <?php
                                    }
                                }	

                                if($o_prod['prod_id']=="p1701")
                                {
                                    if(($creator_qualification['b7_walls']>0)&&($creator_qualification['b7_windows_doors']>0))
                                    {
                            ?>
                                <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" value="<?php echo $all_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_creators[$i]['client_ID'])?"selected":""?>><?php 
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_walls'].")(".$creator_qualification['b7_windows_doors'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_walls'].")(".$creator_qualification['b7_windows_doors'].")";
                                }?> </option>
                            <?php
                                    }
                                }		
                                ...
                                if($creator_right['u_status']=="active")
                                {
                                    if(($o_prod['prod_id']=="p1721")||($o_prod['prod_id']=="p1741"))
                                    {
                                ...
                                ?>
                                    ...
                                    if(!empty($all_creators[$i]['c_last_name'])) 
                                    {
                                        echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_furniture'].")";
                                    }
                                    else
                                    {
                                        echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_furniture'].")";
                                    }?> </option>
                                <?php
                                        }
                                    }												
                                ...
                                if(((substr($o_prod['prod_id'],1)>1701)&&(substr($o_prod['prod_id'],1)<1706))||((substr($o_prod['prod_id'],1)>1721)&&(substr($o_prod['prod_id'],1)<1726))||((substr($o_prod['prod_id'],1)>1741)&&(substr($o_prod['prod_id'],1)<1746)))
                                {
                            ...
                            ?>
                                ...
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_render_stills'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_render_stills'].")";
                                }?> <?php 
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1706")||($o_prod['prod_id']=="p1726")||($o_prod['prod_id']=="p1746"))
                                {
                            ...
                            ?>
                                ...
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_render_360'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_render_360'].")";
                                }?> <?php 
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1707")||($o_prod['prod_id']=="p1727")||($o_prod['prod_id']=="p1747"))
                                {
                            ...
                            ?>
                                ...
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_render_movie'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_render_movie'].")";
                                }?> </option>
                            <?php
                                    }
                                }
                                ...
                                if(($o_prod['prod_id']=="p1708")||($o_prod['prod_id']=="p1728")||($o_prod['prod_id']=="p1748"))
                                {
                                    if($creator_qualification['b7_vr']>0)
                                    {
                            ?>
                                <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" value="<?php echo $all_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_creators[$i]['client_ID'])?"selected":""?>><?php 
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_vr'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_vr'].")";
                                }?> </option>
                            <?php
                                    }
                                }
                        ...
                        for($i=0;$i<count($all_other_creators);$i++)
                        {
                            ...
                            ?>
                                <option id="creator_<?php echo $all_other_creators[$i]['client_ID']; ?>" class="offline" value="<?php echo $all_other_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_other_creators[$i]['client_ID'])?"selected":""?>><?php 
                            ...
                            ?>
                                ...
                                if(!empty($all_other_creators[$i]['c_last_name']))
                                {
                                    echo $all_other_creators[$i]['c_first_name']." ".$all_other_creators[$i]['c_last_name']." - ".$prod->get_company($all_other_creators[$i]['lt_id'])['mailnick']." (".$creator_qualification['b7_walls'].")(".$creator_qualification['b7_windows_doors'].")";
                                }
                                else
                                {
                                    echo $all_other_creators[$i]['l_first_name']." ".$all_other_creators[$i]['l_last_name']." - ".$prod->get_company($all_other_creators[$i]['lt_id'])['mailnick']." (".$creator_qualification['b7_walls'].")(".$creator_qualification['b7_windows_doors'].")";
                                }?> <?php 
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1707")||($o_prod['prod_id']=="p1727")||($b5_in_prods[$k]['prod_id']=="p1747"))
                                {														
                                    if($creator_qualification['b7_render_movie']>0)
                                    {	
                                        if($other_resources_counter==0)
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1708")||($o_prod['prod_id']=="p1728")||($b5_in_prods[$k]['prod_id']=="p1748"))
                                {														
                                    if($creator_qualification['b7_vr']>0)
                                    {	
                                        if($other_resources_counter==0)
                            ...
                            ?>
                                ...
                                if(!empty($all_other_creators[$i]['c_last_name']))
                                {
                                    echo $all_other_creators[$i]['c_first_name']." ".$all_other_creators[$i]['c_last_name']." - ".$prod->get_company($all_other_creators[$i]['lt_id'])['mailnick']." (".$creator_qualification['b7_vr'].")";
                                }
                                else
                                {
                                    echo $all_other_creators[$i]['l_first_name']." ".$all_other_creators[$i]['l_last_name']." - ".$prod->get_company($all_other_creators[$i]['lt_id'])['mailnick']." (".$creator_qualification['b7_vr'].")";
                                }?> <?php 
                        ...
                        <a href="taskdetails.php?o_id=<?php echo $o_prod['o_id'];?>&osub_id=<?php echo $o_prod['osub_id']; ?>&prod_id=<?php echo $o_prod['prod_id'];?>" class="btn btn-sm btn-primary align-self-center mx-1">Details</a>
                    </div>
                </div>
            </div>
            <div class="col-6">
                            ...
                            success:function(data) {
                                ...
                                for(p=0;p<collection.length;p++)
                                {
                                    ...
                                    if(collection[p]!="")
                                    {
                                        ...
                                        if((prod>=1700)&&(prod<1760))
                                        {
                                            $.ajax({
                                            url: "../ajax/coordination_get_b7_in_product.php",
                                            method: "get",
