...
for($i=1;$i<=$total_general_amount;$i++)
{
    if($i<10)
    {
        $data['o_sub_id']="g0".$i;
    ...
    $('#subo_id<?php echo $all_subids[$i]['subo_id'];?>').on('blur',function(){
        $.ajax({
            ...
            data: {
                ...
                general_subname:$(this).val(),
                option:"rename_general_osn_file"},
            dataType:"html",
    ...
    <div class="col">
        ...
        $.ajax({
            ...
            data: {
                ...
                general_subo_more_infos:$(this).val(),
                option:"rename_general_more_infos"
            },
            dataType:"html",
            success:function(data) {
                console.log(data);										
