            ...
            <div class="col-12 col-xl-6 my-1 px-0 d-flex">
                <div class="row mx-0 w-100 align-self-center mb-0 justify-content-center d-flex ">
                    <div class="form-group align-self-center mb-0 d-flex w-100">
                        <select name="creators_<?php echo $global_creator_counter;?>" id="creators_<?php echo $global_creator_counter;?>" class="col-7 form-control form-control-sm align-self-center">
                        ...
                        for($i=0;$i<count($all_creators);$i++)
                        {
                            ...
                            <?php
                                ...
                                if(((substr($o_prod['prod_id'],1)>1761)&&(substr($o_prod['prod_id'],1)<1766))||((substr($o_prod['prod_id'],1)>1781)&&(substr($o_prod['prod_id'],1)<1790)))
                                {
                            ...
                            <?php
                                ...
                                if($o_prod['prod_id']=="p1766")
                                {
                                    if($creator_qualification['b7_render_360']>0)
                                    {
                            ?>
                                <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="b7_render_360_creator_task_count offline" value="<?php echo $all_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_creators[$i]['client_ID'])?"selected":""?>><?php 
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                            ...
                            ?>
                                ...
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b7_environment'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b7_environment'].")";
                                }?> </option>
                            <?php
                                    }
                                }
                        ...
                        for($i=0;$i<count($all_other_creators);$i++)
                        {
                            ...
                            ?>
                                <option id="creator_<?php echo $all_other_creators[$i]['client_ID']; ?>" class="b7_render_360_creator_task_count offline" value="<?php echo $all_other_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_other_creators[$i]['client_ID'])?"selected":""?>><?php 
                                if(!empty($all_other_creators[$i]['c_last_name']))
                                {
                                    echo $all_other_creators[$i]['c_first_name']." ".$all_other_creators[$i]['c_last_name']." (".$creator_qualification['b7_render_360'].")";
                                }
                                else
                                {
                                    echo $all_other_creators[$i]['l_first_name']." ".$all_other_creators[$i]['l_last_name']." (".$creator_qualification['b7_render_360'].")";
                                }?> </option>
                            ...
                            success:function(data) {
                                ...
                                for(p=0;p<collection.length;p++)
                                {
                                    ...
                                    if(collection[p]!="")
                                    {
                                        ...
                                        if((prod>=1760)&&(prod<1799))
                                        {
                                            $.ajax({
                                            url: "../ajax/coordination_get_b7_ex_product.php",
                                            method: "get",
