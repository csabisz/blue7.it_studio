                    ...
                    <div class="form-group align-self-center mb-0 d-flex">
                        ...
                        for($i=0;$i<count($all_creators);$i++)
                        {
                            ...
                            <?php
                                ...
                                if($creator_right['u_status']=="active")
                                {
                                    if(($o_prod['prod_id']=="p1821")||($o_prod['prod_id']=="p1841"))
                                    {
                                ...
                                if(((substr($o_prod['prod_id'],1)>1801)&&(substr($o_prod['prod_id'],1)<1806))||((substr($o_prod['prod_id'],1)>1821)&&(substr($o_prod['prod_id'],1)<1826))||((substr($o_prod['prod_id'],1)>1841)&&(substr($o_prod['prod_id'],1)<1846)))
                                {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1806")||($o_prod['prod_id']=="p1826")||($o_prod['prod_id']=="p1846"))
                                {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1807")||($o_prod['prod_id']=="p1827")||($o_prod['prod_id']=="p1847"))
                                {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1808")||($o_prod['prod_id']=="p1828")||($o_prod['prod_id']=="p1848"))
                                {
                                    if($creator_qualification['b8_vr']>0)
                                    {
                            ?>
                                <option id="creator_<?php echo $all_creators[$i]['client_ID']; ?>" class="offline" value="<?php echo $all_creators[$i]['client_ID'];?>" <?php echo ($o_prod['uca_id']==$all_creators[$i]['client_ID'])?"selected":""?>><?php 
                                if(!empty($all_creators[$i]['c_last_name']))
                                {
                                    echo $all_creators[$i]['c_first_name']." ".$all_creators[$i]['c_last_name']." (".$creator_qualification['b8_vr'].")";
                                }
                                else
                                {
                                    echo $all_creators[$i]['l_first_name']." ".$all_creators[$i]['l_last_name']." (".$creator_qualification['b8_vr'].")";
                                }?> </option>
                            <?php
                                    }
                                }
                        ...
                        for($i=0;$i<count($all_other_creators);$i++)
                        {
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1807")||($o_prod['prod_id']=="p1827")||($b5_in_prods[$k]['prod_id']=="p1847"))
                                {														
                                    if($creator_qualification['b8_render_movie']>0)
                                    {	
                                        if($other_resources_counter==0)
                            ...
                            <?php
                                ...
                                if(($o_prod['prod_id']=="p1808")||($o_prod['prod_id']=="p1828")||($b5_in_prods[$k]['prod_id']=="p1848"))
                                {														
                                    if($creator_qualification['b8_vr']>0)
                                    {	
                                        if($other_resources_counter==0)
                            ...
                            ?>
                                ...
                                if(!empty($all_other_creators[$i]['c_last_name']))
                                {
                                    echo $all_other_creators[$i]['c_first_name']." ".$all_other_creators[$i]['c_last_name']." - ".$prod->get_company($all_other_creators[$i]['lt_id'])['mailnick']." (".$creator_qualification['b8_vr'].")";
                                }
                                else
                                {
                                    echo $all_other_creators[$i]['l_first_name']." ".$all_other_creators[$i]['l_last_name']." - ".$prod->get_company($all_other_creators[$i]['lt_id'])['mailnick']." (".$creator_qualification['b8_vr'].")";
                                }?> <?php 
                            ...
                            success:function(data) {
                                ...
                                for(p=0;p<collection.length;p++)
                                {
                                    ...
                                    if(collection[p]!="")
                                    {
                                        ...
                                        if((prod>=1800)&&(prod<1860))
                                        {
                                            $.ajax({
                                            url: "../ajax/coordination_get_b8_in_product.php",
                                            method: "get",
