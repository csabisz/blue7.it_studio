	...
	{									
		...
		<?php 
			...
			if(isset($_POST['create_btn']))
			{
				...
				$prod->create_main_client_position(json_encode($register_data));
		...
		<form name="register_form" id="register_form" method="post" action="create.php" enctype="multipart/form-data"></form>
			<div class="row mx-0 w-100 my-2 border py-4">
				<div class="col-md-6 pr-0">            
					<div class="row w-100 mx-0">
						...
						<div class="col-md-5">
							<select id="mc_id" name="mc_id" class="form-control form-control-sm border-danger" form="register_form" required>
					...
					<div class="row w-100 mx-0">
						...
						<div class="col-md-5">
							<input class="form-control form-control-sm border-danger" type="text" id="position" name="position" value="" form="register_form">
						</div>
					</div>            
					<div class="row w-100 mx-0">
						<div class="col-md-5">
						...
						<div class="col-md-5">
							<input type="text" id="boss_c_id2" list="boss_c_id_list" name="boss_c_id2" class="form-control form-control-sm border-danger" form="" required>                
							...
							<input type="hidden" id="boss_c_id" name="boss_c_id" value="" form="register_form">
			...
			<div class="row w-100 mx-0">
				<div class="col-md-12 d-flex justify-content-center">
					<div class="center_message">
						<button type="submit" name="create_btn" class="btn btn-primary btn-sm" form="register_form">Create</button>			
					</div>
				</div>
			</div>	
