...
<div id="header_order_id" class="sticky-top" style="background-color: #FBFBFB; padding: 10px;">
        ...
        <!--<div class="row w-100 mx-0 project-details d-flex justify-content-center pb-4">
            ...
            <div class="col-md-4">
                ...
                if ($order['om_id'] == 0) {
                    ...
                    echo $order['om_id'];
                } ?>" class="btn yellow-light btn-sm px-2 ml-4 mr-auto mr-md-0 ml-md-4 ml-auto d-md-inline"
                   target="_blank">Presentation for checkers</a><br>
